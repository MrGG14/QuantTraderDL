...
class SVMWaveletForecastingAlgorithm(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.set_warmup(period, Resolution.DAILY)  

        for ticker in ["EURUSD", "GBPUSD", "AUDCAD", "NZDCHF"]:
    ...
    def _consolidation_handler(self, bar):
        ...
        forecasted_value = self._wavelet.forecast(prices, model='lstm', threshold = 0.5)
